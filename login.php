                    ...
                    <div class="container-xl px-4">
                        <div class="row justify-content-center">
                            ...
                            <?php 
                                if ($s_success !== "") { 
                                ?>
                                <div class="alert alert-success alert-notif alert-dismissible fade show" role="alert">
                                   <?php echo $s_success; ?>
                                ...
                                if ($s_info !== "") {
                                ?>
                                <div class="alert alert-info alert-dismissible alert-notif fade show" role="alert">
                                   <?php echo $s_info; ?>
                                ...
                                if ($s_warning !== "") {
                                ?>
                                <div class="alert alert-warning alert-dismissible alert-notif  fade show" role="alert">
                                   <?php echo $s_warning; ?>
                                </div>
                                <?php 
                                }
                                if ($s_error !== "") {
                                ?>
                                <div class="alert alert-danger alert-dismissible alert-notif fade show" role="alert">
                                   <?php echo $s_error; ?>
                                </div>
                                <?php 
                                }
