...
try{
    $sql = "INSERT INTO testing(tanggal, waktu, accel_x, accel_y, accel_z, compass_x,compass_y, compass_z, gyro_x,gyro_y,gyro_z,gyro_temp,dht_temp,dht_hum, analog_24v1,
            ...
            VALUES(CURDATE(), CURTIME(), $accel_x,$accel_y,$accel_z,$compass_x, $compass_y, $compass_z, $gyro_x,$gyro_y,$gyro_z,$gyro_temp, $dht_temp,$dht_hum, $analog_24v1,
