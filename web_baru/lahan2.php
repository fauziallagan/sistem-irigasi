...
require 'dataxl2kelembapan.php'; //a> memasukan memnaggil fungsi
require 'datayl2waktu.php'; //a> memasukan memnaggil fungsi
require 'dataxl2ph.php';
require 'dataxl2kalium.php';
require 'dataxl2potasium.php';
