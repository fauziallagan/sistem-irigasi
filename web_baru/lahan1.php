...
require 'dataxlahan1kelembapan.php'; //a> memasukan memnaggil fungsi
require 'dataylahan1kelembapan.php'; //a> memasukan memnaggil fungsi
require 'dataxl1ph.php';
require 'dataxl1kalium.php';
require 'dataxl1potasium.php';
