...
<html lang="en">
    <head>
        ...
        esheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    </head>
    <body>
            ...
            <div id="layoutDefault_content">
                <main>
                        ...
                        <div class="page-header-ui-content pt-10">
                            <div class="container px-5">
                                <div class="row gx-5 align-items-center">
                                    ...
                                    <div class="col-lg-6 d-none d-lg-block" data-aos="fade-up" data-aos-delay="100"><img class="img-fluid" src="assets/img/irigasi/client.jpg" /></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container px-5">
                            ...
                            <div class="row gx-5 align-items-center justify-content-center">
                                ...
                                <div class="col-md-9 col-lg-6 order-1 order-lg-0" data-aos="fade-right">
                                    <div class="content-skewed content-skewed-right"><img class="content-skewed-item img-fluid1 shadow-md rounded-3 w-100" src="./assets/img/irigasi/tancep.jpg" alt="No Image View" /></div>
                                </div>
                        ...
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center justify-content-center">
                                ...
                                <div class="col-md-9 col-lg-6" data-aos="slide-left">
                                    <div class="mb-4">
                                        <div class="content-skewed content-skewed-left"><img class="img-fluid content-skewed-item shadow-lg rounded-3" src="assets/img/irigasi/pemasangan.jpg" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- <section class="bg-dark py-5">
                          <h1 class="text-center show bg-transparent">
                            Show Case
                        </h1>
                        <br>
                          <div class="container px-5">
                            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <img src="./assets/img/materi/slider/slider1.png" class="d-block" alt="..."> -->
                                  ...
                                  <!-- <div class="carousel-item"> -->
                                    <!-- <img src="./assets/img/materi/slider/slide1.png" class="d-block" alt="..."> -->
                                    <!-- <div class="carousel-caption d-none d-md-block">
                                  ...
                                  <!-- </div> -->
                                  <!-- <div class="carousel-item">
                                    <img src="./assets/img/illustrations/programming.svg" class="d-block" alt="..."> -->
                                    <!-- <div class="carousel-caption d-none d-md-block">
