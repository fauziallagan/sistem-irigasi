                                    ...
                                    <div class="card-body">
                                        <form action="coba.php" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="inputUsername" type="text" placeholder="Enter your Name" value="<?php echo $nama ?>" required autocomplete="false" name="nama" readonly = "readonly"/>
                                            </div>
                                            <!-- Form Group (username)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="inputUsername">Username </label>
                                                <input class="form-control" id="inputUsername" type="text" placeholder="Enter your username" value="<?php echo $username ?>" required autocomplete="false" readonly = "readonly"/>
                                            </div>
                                            <!-- Form Group (Email)-->
                                           <div class="mb-3">
                                                <label class="small mb-1" for="inputEmail">Email</label>
                                                <input class="form-control" id="email" type="text" placeholder="Enter your Email" value="<?php echo $email?>" required autocomplete="false"  readonly = "readonly"/>
                                            </div>  
                                            <!-- Form Row-->
                                            <div class="mb-3">
                                            ...
                                            <!-- Save changes button-->
                                            <button class="btn btn-primary disabled" type="submit" name="updatePengguna">Save changes</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
